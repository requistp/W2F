...
let createTerrain (game:Game) =
    ...
    game.MapSize
    |> mapLocations 
    |> Array.map (fun l -> make l)
    |> Engine.Entities.creates game
    //|> game.Entities.creates
    //game
...
//            Engine.Entities.createEntity g (make (Location.random game.MapSize) g.Entities.NewEntityID g.Entities.MaxComponentID)
//            ) game
...
//            Engine.Entities.createEntity g (make (Location.random game.MapSize) g.Entities.NewEntityID g.Entities.MaxComponentID i)
//            ) game
